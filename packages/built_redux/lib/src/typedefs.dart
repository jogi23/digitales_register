...
/// [Reducer] is a function that given a state, an Action, and a builder builds
/// the next state.
...
/// [NextActionHandler] takes the next [ActionHandler] in the middleware chain
/// and returns an [ActionHandler] for the middleware.
typedef NextActionHandler = ActionHandler Function(ActionHandler next);

/// [Middleware] is a function that given the store's [MiddlewareApi] returns a
/// [NextActionHandler].
typedef Middleware<
...
/// [SubstateChange] is the payload for substateStream's stream.
